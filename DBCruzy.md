...
CREATE TABLE public.cash_deposits (
  ...
  line_notified boolean DEFAULT false,
  updated_at timestamp with time zone DEFAULT now(),
  slip_ocr_status character varying DEFAULT 'unchecked'::character varying,
  slip_ocr_amount numeric,
  slip_ocr_confidence numeric,
  slip_ocr_text text,
  slip_ocr_checked_at timestamp with time zone,
  audit_actor_type character varying,
  audit_actor_id character varying,
  audit_actor_name text,
...
CREATE TABLE public.bank_account_branches (
  bank_account_id integer NOT NULL,
  branch_id integer NOT NULL,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT bank_account_branches_pkey PRIMARY KEY (bank_account_id, branch_id),
  CONSTRAINT bank_account_branches_bank_account_id_fkey FOREIGN KEY (bank_account_id) REFERENCES public.bank_accounts(id),
  CONSTRAINT bank_account_branches_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.branch_cash_ledger (
  id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
  branch_id integer NOT NULL,
  ledger_date date NOT NULL,
  entry_type character varying NOT NULL CHECK (entry_type::text = ANY (ARRAY['sale_cash'::character varying, 'deposit'::character varying, 'adjustment'::character varying]::text[])),
  sale_id bigint,
  cash_deposit_id bigint,
  amount numeric NOT NULL,
  note text,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT branch_cash_ledger_pkey PRIMARY KEY (id),
  CONSTRAINT branch_cash_ledger_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT branch_cash_ledger_sale_id_fkey FOREIGN KEY (sale_id) REFERENCES public.sales(id),
  CONSTRAINT branch_cash_ledger_cash_deposit_id_fkey FOREIGN KEY (cash_deposit_id) REFERENCES public.cash_deposits(id)
);